...
![Prediction Q]([screenshots/q.png](https://github.com/AditiGaure/Real-time-sign-language-Translator-A-Machine-Learning-based-approach/blob/main/screenshots/Screenshot%202026-03-17%20172049.png))

### 🔹 Real-Time Prediction (Example 4)
![Prediction Q]([screenshots/q.png](https://github.com/AditiGaure/Real-time-sign-language-Translator-A-Machine-Learning-based-approach/blob/main/screenshots/Screenshot%202026-03-17%20172134.png))
